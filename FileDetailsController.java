package com.hitachi.consulting.controller;
...
import com.hitachi.consulting.VO.UploadFileResponse;
...
public class FileDetailsController {
    ...
    public UploadFileResponse uploadFile(@RequestParam("file") MultipartFile file) {
        String fileName = fileDetailsService.storeFile(file);
    ...
    public ResponseEntity<Resource> downloadFile(@PathVariable String fileName, HttpServletRequest request) {
        ...
        Resource resource = fileDetailsService.loadFileAsResource(fileName);
